...
---@return string
function M.title()
    return core.call_api("gp.app.title")
end

---Описание игры
---@return string
function M.description()
    return core.call_api("gp.app.description")
end

---Изображение
---@return string
function M.image()
    return core.call_api("gp.app.image")
end

---Url игры
---@return string
function M.url()
    return core.call_api("gp.app.url")
end
...
function M.request_review(callback)
    ...
    core.call_api("gp.app.requestReview", nil, callback)
end

---Проверить поддержку возможности оставить отзыв на игру
---@return boolean
function M.can_request_review()
    return core.call_api("gp.app.canRequestReview") == true
end

---Проверить был ли оставлен отзыв
---@return boolean
function M.is_already_reviewed()
    return core.call_api("gp.app.isAlreadyReviewed") == true
end
