...
function M.claim_day(id_or_tag, day, callback)
    ...
    core.call_api("gp.schedulers.claimDay", { id_or_tag, day }, callback)
end
...
function M.claim_day_additional(id_or_tag, day, trigger_id_or_tag, callback)
    ...
    helpers.check_callback(callback)
    core.call_api("gp.schedulers.claimDayAdditional", { id_or_tag, day, trigger_id_or_tag }, callback)
end
...
function M.claim_all_day(id_or_tag, day, callback)
    ...
    helpers.check_number(day, "day")
    helpers.check_callback(callback)
    core.call_api("gp.schedulers.claimAllDay", { id_or_tag, day }, callback)
end
...
function M.claim_all_days(id_or_tag, callback)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    helpers.check_callback(callback)
    core.call_api("gp.schedulers.claimAllDays", id_or_tag, callback)
end

---Список планировщиков
---@return table результат
function M.list()
    return core.call_api("gp.schedulers.list")
end

---Список активных планировщиков игрока
---@return table результат
function M.active_list()
    return core.call_api("gp.schedulers.activeList")
end
...
function M.get_scheduler(id_or_tag)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    return core.call_api("gp.schedulers.getScheduler", id_or_tag)
end
...
function M.get_scheduler_day(id_or_tag, day)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    helpers.check_number(day, "day")
    return core.call_api("gp.schedulers.getSchedulerDay", { id_or_tag, day })
end
...
function M.get_scheduler_current_day(id_or_tag)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    return core.call_api("gp.schedulers.getSchedulerCurrentDay", id_or_tag)
end
...
function M.is_registered(id_or_tag)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    return core.call_api("gp.schedulers.isRegistered", id_or_tag) == true
end
...
function M.is_today_reward_claimed(id_or_tag)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    return core.call_api("gp.schedulers.isTodayRewardClaimed", id_or_tag) == true
end
...
function M.can_claim_day(id_or_tag, day)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    helpers.check_number(day, "day")
    return core.call_api("gp.schedulers.canClaimDay", { id_or_tag, day }) == true
end
...
function M.can_claim_day_additional(id_or_tag, day, trigger_id_or_tag)
    ...
    helpers.check_number(day, "day")
    helpers.check_string(trigger_id_or_tag, "trigger_id_or_tag")
    return core.call_api("gp.schedulers.canClaimDayAdditional", { id_or_tag, day, trigger_id_or_tag }) == true
end
...
function M.can_claim_all_day(id_or_tag, day)
    helpers.check_string_or_number(id_or_tag, "id_or_tag")
    helpers.check_number(day, "day")
    return core.call_api("gp.schedulers.canClaimAllDay", { id_or_tag, day }) == true
end
